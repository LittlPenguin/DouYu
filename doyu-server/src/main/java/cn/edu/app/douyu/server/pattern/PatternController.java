...
public class PatternController {
    ...
    Map<String, Object> createJob(Authentication authentication, @Valid @RequestBody CreateJobRequest request) throws JsonProcessingException {
        ...
        Map<String, Object> view = jobView(job);
        jobExecutor.executeAsync(job, input);
        return view;
    }
    ...
    private Map<String, Object> jobView(PatternJobEntity job) {
        ...
        data.put("progress", job.getProgress() != null ? job.getProgress() :
                "SUCCEEDED".equals(job.getStatus()) ? 1.0 : "PENDING".equals(job.getStatus()) ? 0.0 : 0.5);
