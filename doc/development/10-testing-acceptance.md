...
- 我的页有“点赞作品”“评论作品”“收藏作品”“关注作品”四个独立入口；各页面有加载、空、错、未登录状态，帖子卡可跳转作品详情。
...
- 截图保存到 `.qa-output/`，不提交。
- 验证作品详情顶部无透明空白，评论栏折叠态不堆叠、左侧按钮可展开/收起，展开态素材 Chip、多行输入、工具栏和发送区分层清楚；继续验证图片、@、#、贴纸、提交成功提示、评论列表无“审核中”、互动按钮高亮回显和我的页四个互动资产页跳转。
